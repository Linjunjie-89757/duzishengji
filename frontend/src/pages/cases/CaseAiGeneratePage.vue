  ...
  <section class="ai-generate-page">
    ...
    <div class="main-content-grid">
        ...
        <div class="panel-title-row">
          <div>
            <div class="section-title section-title-with-icon">
              <el-icon class="section-title-icon" aria-hidden="true"><EditPen /></el-icon>
              <span>手动输入需求描述</span>
            </div>
          </div>
        </div>
      ...
      <div class="panel-card upload-panel">
        <div class="panel-title-row">
          <div>
            <div class="section-title section-title-with-icon">
              <el-icon class="section-title-icon" aria-hidden="true"><UploadFilled /></el-icon>
              <span>上传需求文档</span>
            </div>
          </div>
        </div>
    ...
    <div class="panel-card ai-config-card">
      <div class="panel-title-row">
        <div>
            <div class="section-title section-title-with-icon">
              <el-icon class="section-title-icon output-section-icon" aria-hidden="true"><DataAnalysis /></el-icon>
              <span>输出模式设置</span>
            </div>
      ...
      <div class="output-mode-grid output-mode-grid-visual">
        <label class="output-mode-card output-mode-card-visual" :class="{ 'output-mode-card-active': manualForm.outputMode === 'STREAM' }">
          ...
          <div class="output-mode-title">
            <el-icon class="output-mode-icon output-mode-icon-stream" aria-hidden="true"><Lightning /></el-icon>
            <span>实时流式输出</span>
          </div>
        ...
        <label class="output-mode-card output-mode-card-visual" :class="{ 'output-mode-card-active': manualForm.outputMode === 'COMPLETE' }">
          ...
          <div class="output-mode-title">
            <el-icon class="output-mode-icon output-mode-icon-complete" aria-hidden="true"><Document /></el-icon>
            <span>完整输出</span>
          </div>
    ...
    <div class="panel-card ai-config-card">
      <div class="panel-title-row">
        <div>
            <div class="section-title section-title-with-icon">
              <el-icon class="section-title-icon" aria-hidden="true"><Setting /></el-icon>
              <span>当前 AI 配置</span>
            </div>
    ...
    <div class="recent-task-card">
      <div class="panel-title-row recent-task-header">
        <div>
          <div class="section-title section-title-with-icon">
            <el-icon class="section-title-icon" aria-hidden="true"><Clock /></el-icon>
            <span>最近任务</span>
          </div>
...
.output-mode-card-active {
  border-color: rgba(36, 107, 255, 0.32);
  background: #f8fbff;
  box-shadow: none;
}
